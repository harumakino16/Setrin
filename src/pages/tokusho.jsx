...
const TermsOfUse = () => {
  const seoData = {
    title: '特定商取引法に基づく表示 | Setlink - VTuberのための歌枠支援ツール',
    description: 'Setlinkの特定商取引法に基づく表示です。事業者情報、支払方法、返品・交換について等の重要な情報を掲載しています。',
    openGraph: {
      title: '特定商取引法に基づく表示 | Setlink',
      description: 'Setlinkの特定商取引法に基づく表示です。事業者情報、支払方法、返品・交換について等の重要な情報を掲載しています。',
      url: 'https://setlink.jp/tokusho',
      type: 'website',
      images: [
        {
