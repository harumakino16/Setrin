...
const PrivacyPolicy = () => { 
  const seoData = {
    title: 'プライバシーポリシー | Setlink - VTuberのための歌枠支援ツール',
    description: 'Setlinkのプライバシーポリシーです。ユーザー情報の取り扱い、個人情報保護方針について説明しています。',
    openGraph: {
      title: 'プライバシーポリシー | Setlink',
      description: 'Setlinkのプライバシーポリシーです。ユーザー情報の取り扱い、個人情報保護方針について説明しています。',
      url: 'https://setlink.jp/privacypolicy',
      type: 'website',
      images: [
        {
