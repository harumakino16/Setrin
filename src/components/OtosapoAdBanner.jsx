        ...
        <div className="mt-8 mb-4 mx-auto max-w-4xl">
            <div className="bg-white border-2 border-[#ea580c] rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="flex flex-col md:flex-row items-center">
                    {/* ロゴ部分 */}
                    <div className="w-full md:w-1/4 flex justify-center items-center p-4 md:pl-6">
                    ...
                    {/* メインコンテンツ部分 */}
                    <div className="w-full md:w-2/4 text-gray-800 p-4 md:p-2">
                        <h3 className="font-bold text-[#ea580c] text-2xl mb-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                            ...
                            <span className="text-xs text-gray-700 font-semibold">3/17～3/24まで</span>
                        </div>
                        <div className="flex flex-wrap items-center gap-2">
                            <span className="inline-block bg-[#ea580c] text-white font-bold py-1 px-3 rounded-md text-sm">10% OFF</span>
                            <span className="text-xs text-gray-700 font-semibold">Setlinkユーザー専用コード: SETLINK10</span>
                        </div>
                    </div>

                    {/* 特徴リスト部分 */}
                    <div className="w-full md:w-1/4 bg-gray-50 p-4 md:pr-6 md:py-4 border-t md:border-t-0 md:border-l border-gray-100">
